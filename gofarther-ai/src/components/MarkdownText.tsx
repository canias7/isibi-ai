...
export default function MarkdownText({ children, colors }: Props) {
  const textColor = colors?.text === '#f2f2f2' ? '#f2f2f2' : '#000000';
...
const ms = StyleSheet.create({
  ...
  inlineCode: { backgroundColor: '#f0f0f0', paddingHorizontal: 5, paddingVertical: 1, borderRadius: 5, fontFamily: Platform.OS === 'ios' ? 'Menlo' : 'monospace', fontSize: 14, color: '#000000', overflow: 'hidden' },
  inlineCodeDark: { backgroundColor: '#2a2a2a', color: '#e0e0e0' },
  h1: { fontSize: 24, fontWeight: '700', color: '#000000', marginTop: 8, marginBottom: 4 },
  h2: { fontSize: 20, fontWeight: '700', color: '#000000', marginTop: 6, marginBottom: 4 },
  h3: { fontSize: 17, fontWeight: '600', color: '#000000', marginTop: 4, marginBottom: 2 },
  listItem: { flexDirection: 'row', marginVertical: 3, paddingRight: 16 },
  bullet: { fontSize: 16, color: '#666', lineHeight: 24, width: 20 },
  numBullet: { fontSize: 16, color: '#666', lineHeight: 24, width: 24 },
  listText: { flex: 1, fontSize: 16, color: '#000000', lineHeight: 24 },
