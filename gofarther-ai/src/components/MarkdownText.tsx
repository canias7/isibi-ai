...
const ms = StyleSheet.create({
  body: { fontSize: 16, color: '#1a1a1a', lineHeight: 24 },
  bold: { fontWeight: '700' },
  italic: { fontStyle: 'italic' },
  link: { color: '#0066cc', textDecorationLine: 'underline' as any },
  inlineCode: { backgroundColor: '#f0f0f0', paddingHorizontal: 5, paddingVertical: 1, borderRadius: 5, fontFamily: Platform.OS === 'ios' ? 'Menlo' : 'monospace', fontSize: 14, color: '#1a1a1a', overflow: 'hidden' },
  inlineCodeDark: { backgroundColor: '#2a2a2a', color: '#e0e0e0' },
  h1: { fontSize: 24, fontWeight: '700', color: '#1a1a1a', marginTop: 8, marginBottom: 4 },
  h2: { fontSize: 20, fontWeight: '700', color: '#1a1a1a', marginTop: 6, marginBottom: 4 },
  h3: { fontSize: 17, fontWeight: '600', color: '#1a1a1a', marginTop: 4, marginBottom: 2 },
  ...
  listText: { flex: 1, fontSize: 16, color: '#1a1a1a', lineHeight: 24 },
