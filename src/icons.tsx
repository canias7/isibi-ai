...
// Refresh / reload (Lucide refresh-cw): two curved arrows forming a circle.
...
// Inbox tray (Lucide inbox).
export const IconInbox = ({ size }: { size?: number }) => (
  <Svg size={size}>
...
// Contacts / people (Lucide users).
export const IconContacts = ({ size }: { size?: number }) => (
  <Svg size={size}>
...
export const IconWebhook = ({ size }: { size?: number }) => (
  <Svg size={size}>
