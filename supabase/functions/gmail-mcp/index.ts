...
const ALLOWED: Record<string, string[]> = {
  ...
  todoist: ["TODOIST_GET_ALL_COMMENTS", "TODOIST_GET_ALL_PROJECTS", "TODOIST_GET_ALL_TASKS", "TODOIST_GET_BACKUPS", "TODOIST_GET_COMPLETED_TASKS_BY_COMPLETION_DATE", "TODOIST_GET_PERSONAL_LABEL"],
  googletasks: ["GOOGLETASKS_UPDATE_TASK_FULL"],
  asana: ["ASANA_GET_ACCESS_REQUESTS", "ASANA_GET_ALLOCATION", "ASANA_GET_ALLOCATIONS", "ASANA_GET_A_PROJECT", "ASANA_GET_A_TASK", "ASANA_GET_ATTACHMENT"],
  trello: ["TRELLO_ADD_LISTS", "TRELLO_GET_BOARDS_BY_ID_BOARD", "TRELLO_GET_BOARDS_CARDS_BY_ID_BOARD", "TRELLO_GET_LISTS_BOARD_BY_ID_LIST", "TRELLO_GET_MEMBERS_BY_ID_MEMBER", "TRELLO_GET_MEMBERS_ME"],
  ...
  salesforce: ["SALESFORCE_EXECUTE_SOSL_SEARCH", "SALESFORCE_GET_A_BATCH_OF_RECORDS", "SALESFORCE_GET_ACCOUNT", "SALESFORCE_GET_ALL_FIELDS_FOR_OBJECT", "SALESFORCE_GET_CAMPAIGN", "SALESFORCE_GET_COMPOSITE_RESOURCES"],
  ...
  stripe: ["STRIPE_DELETEV1_SUBSCRIPTIONS_LIST_SUBSCRIPTIONS", "STRIPE_GET_BALANCE_HISTORY", "STRIPE_GET_CHARGES_CHARGE_REFUNDS_REFUND", "STRIPE_GET_CHECKOUT_SESSIONS_SESSION_LINE_ITEMS", "STRIPE_GET_CUSTOMERS_CUSTOMER_BANK_ACCOUNTS_ID", "STRIPE_GET_CUSTOMERS_CUSTOMER_CASH_BALANCE"],
  ...
  sendgrid: ["SENDGRID_RETRIEVE_ALL_LISTS", "SENDGRID_ADD_AN_IP_ADDRESS_TO_A_POOL"],
