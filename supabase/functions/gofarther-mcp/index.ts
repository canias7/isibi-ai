...
const ALLOWED: Record<string, string[]> = {
  ...
  excel: ["EXCEL_LIST_FILES", "EXCEL_LIST_WORKSHEETS", "EXCEL_GET_RANGE", "EXCEL_UPDATE_RANGE", "EXCEL_LIST_TABLES", "EXCEL_LIST_TABLE_ROWS", "EXCEL_ADD_TABLE", "EXCEL_CREATE_WORKBOOK"],
