...
ALLOWED: dict[str, list[str]] = {
    ...
    # NOTE: Composio's Outlook has NO working email message tools — every
    # send/read/search/reply/forward slug 404s on execute (71 of them). Only
    # calendar/folders/rules/attachments/settings/mail-delta execute. These are
    # the execute-validated working ones; email actions need a direct MS Graph
    # integration (see toolmap seam), not Composio.
    "outlook": ["OUTLOOK_GET_MAIL_DELTA", "OUTLOOK_LIST_CALENDARS", "OUTLOOK_CREATE_CALENDAR", "OUTLOOK_LIST_REMINDERS", "OUTLOOK_CREATE_EMAIL_RULE", "OUTLOOK_CREATE_MAIL_FOLDER", "OUTLOOK_LIST_OUTLOOK_ATTACHMENTS", "OUTLOOK_CREATE_CONTACT_FOLDER", "OUTLOOK_GET_MAIL_TIPS", "OUTLOOK_CREATE_MASTER_CATEGORY", "OUTLOOK_UPDATE_MAILBOX_SETTINGS", "OUTLOOK_LIST_EVENT_ATTACHMENTS"],
    ...
    "dropbox": ["DROPBOX_SEARCH_FILE_OR_FOLDER", "DROPBOX_LIST_FOLDERS", "DROPBOX_LIST_FILES_IN_FOLDER", "DROPBOX_READ_FILE", "DROPBOX_GET_ABOUT_ME", "DROPBOX_CREATE_FOLDER", "DROPBOX_UPLOAD_FILE", "DROPBOX_CREATE_FILE_REQUEST", "DROPBOX_MOVE_FILE_OR_FOLDER", "DROPBOX_DELETE_FILE_OR_FOLDER"],
    ...
    "freshdesk": ["FRESHDESK_GET_TICKETS", "FRESHDESK_VIEW_TICKET", "FRESHDESK_CREATE_TICKET", "FRESHDESK_UPDATE_TICKET", "FRESHDESK_DELETE_TICKET"],
    ...
    "quickbooks": ["QUICKBOOKS_READ_CUSTOMER", "QUICKBOOKS_QUERY_ACCOUNT", "QUICKBOOKS_READ_ACCOUNT", "QUICKBOOKS_READ_VENDOR", "QUICKBOOKS_READ_EMPLOYEE", "QUICKBOOKS_CREATE_CUSTOMER", "QUICKBOOKS_CREATE_ACCOUNT", "QUICKBOOKS_CREATE_VENDOR", "QUICKBOOKS_CREATE_EMPLOYEE", "QUICKBOOKS_CUSTOMER_BALANCE_REPORT", "QUICKBOOKS_CUSTOMER_BALANCE_DETAIL", "QUICKBOOKS_VENDOR_BALANCE_DETAIL"],
    "xero": ["XERO_GET_CONTACTS", "XERO_GET_QUOTES", "XERO_GET_CONNECTIONS", "XERO_POST_INVOICE_UPDATE"],
