...
show("ADVISE",      make_data.gen_advise)
show("CONCEPT",     make_data.gen_concept)
show("CONSULT",     make_data.gen_consult)
show("SCHEMA",      make_data.gen_schema)
show("NL-ENTRY",    make_data.gen_nlentry)
show("CHITCHAT",    make_data.gen_chitchat)
show("FUNC-REF",    make_data.gen_funcref)
show("ERR-REF",     make_data.gen_errref)
show("NUM-FORMAT",  make_data.gen_numformat)
show("TIPS",        make_data.gen_tips)
