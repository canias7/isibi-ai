...
export function LoginPage({ onLogin, onNeedVerify }: Props) {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      {/* Left branding panel */}
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center items-center px-12 py-16 relative overflow-hidden"
          ...
          <div className="mt-10 space-y-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-white/60">Describe what you want and watch it come to life</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/20">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-white/60">One-click deploy to production with custom domains</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/20">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-white/60">Publish and monetize your apps on the isibi marketplace</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              disabled
              className="flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-medium text-gray-400 cursor-not-allowed"
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            ...
            <Link to="/signup" className="font-semibold hover:underline" style={{ color: "#ec4899" }}>
              Sign up
            </Link>
          </p>
